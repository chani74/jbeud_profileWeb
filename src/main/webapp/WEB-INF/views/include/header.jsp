...
<body>
	...
	<tr class="header_line" height=50px align="center">
		...
		<td width=2%>&nbsp;</td>
		<td width=5% ><a href="#" class="header_link"><span class="header_menu">BOARD</span></a></td>
		<td width=2%>&nbsp;</td>
		<td width=5% ><a href="#" class="header_link"><span class="header_menu">CONTACT</span></a></td>
		<td width=4%>&nbsp;</td>
