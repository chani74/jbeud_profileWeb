			...
			<table border=0 cellpadding=8 cellspacing=0 >
				...
				<td align=center class="content_box">
					<table border=0 cellpadding=10 cellspacing=0 >
						<form action="modifyContentOk" method="post" name="writeForm" onSubmit="return writeCheck();">
						...
						<tr>
							...
							<td><input type="text" name="btitle" class="input_box" style="width:500px;" value="${bdto.btitle}" > </td>
						</tr>
						<tr>
							<td align=right><span class="content_text">내용 :</span></td>
							<td><textarea rows="10" cols="70" name="bcontent" class="input_box" >${bdto.bcontent}</textarea>
						</tr>																	
						...
						<tr>
							<td colspan=2 align=center>
								...
								<input type="button" value="수정취소" class="content_btn" onclick="javascript:location.href='list';">
							</td>
